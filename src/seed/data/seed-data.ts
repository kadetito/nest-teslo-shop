...
export const initialData: SeedData = {
  users: [
    {
      email: 'rpenya@syntonize.com',
      fullName: 'Rafa',
      surName: 'Penya',
      telefono: '677888777',
      address: 'C/ Velazquez 2 17 43830',
      create_pin: 'PINTSG73863',
      cc_aa: 'Cataluña',
      card_club: 'CARDCLUB678387678623',
      password: bcrypt.hashSync('ABc123', 10),
      roles: ['superadmin'],
    },
    {
      email: 'rafapenya@syntonize.com',
      fullName: 'Rafael',
      surName: 'Peña',
      telefono: '909888777',
      address: 'C/ Laietana 2 17 43830',
      create_pin: 'PINTS9936563',
      cc_aa: 'Galicia',
      card_club: 'CARDCLUB678112323',
      password: bcrypt.hashSync('Abc123', 10),
      roles: ['admin'],
    },
  ],
